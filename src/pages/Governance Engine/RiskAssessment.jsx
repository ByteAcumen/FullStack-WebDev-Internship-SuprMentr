  ...
  const handleGetStarted = () => {
    navigate('/get-started', {
      state: {
        ...
        referral: 'risk-assessment-landing'
      }
    });
  };
  ...
  const benefits = [
    {
      ...
      description: "We conduct thorough assessments to identify all potential security risks across your organization's digital and physical assets."
    },
    {
      title: "Regulatory Compliance",
      description: "Our assessments ensure you meet industry regulations and compliance requirements, reducing legal risks and potential fines."
    },
    {
      title: "Threat Prioritization",
      description: "We help you understand which risks pose the greatest threat to your business, allowing for strategic resource allocation."
    },
    {
      title: "Customized Mitigation Strategies",
      description: "Receive tailored recommendations to address your specific vulnerabilities and strengthen your security posture."
    },
    {
      title: "Ongoing Monitoring",
      description: "We provide continuous risk monitoring services to help you stay ahead of emerging threats in real-time."
    }
  ];
      ...
      <nav className="p-4 bg-white shadow-sm">
        <div className="container mx-auto">
          <div className="breadcrumbs text-sm">
            ...
            <span className="mx-2 text-gray-500">»</span>
            <span className="text-gray-800 font-medium">Risk Assessment & Management</span>
          </div>
        </div>
      </nav>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:gap-16">
            ...
            >
              ...
              <motion.p
                ...
                variants={fadeIn(0.4)}
              >
                Codezye Cyber's comprehensive risk assessment services help organizations identify vulnerabilities, 
                evaluate threats, and implement effective mitigation strategies to protect critical assets and 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl text-center">
          ...
          >
            ...
            >
              ...
              <span>NAVIGATE THE COMPLEX WORLD OF SECURITY RISKS</span>
              <span className="w-2 h-2 rounded-full bg-blue-700"></span>
            </motion.div>
            <motion.h2
              className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-6 tracking-tight leading-tight text-blue-600"
              variants={fadeIn(0.3)}
            >
              Navigate the Complex World of Security Risks with Confidence
            </motion.h2>
            <motion.p
              className="text-xl text-gray-700 mb-6 leading-relaxed"
              variants={fadeIn(0.4)}
            >
              In today's rapidly evolving threat landscape, simply having basic security measures isn't enough. You need a comprehensive understanding of your risks, a clear strategy for addressing them, and the expertise to implement effective solutions. That's where our Risk Assessment services come in.
            </motion.p>
            <motion.p
              className="text-gray-600 text-lg leading-relaxed"
              variants={fadeIn(0.5)}
            >
              We're not just risk assessors – we're security strategists who work closely with your team to identify vulnerabilities, evaluate threats, and develop robust mitigation strategies that protect your critical assets and ensure business continuity.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-7xl">
          ...
          >
            ...
            <motion.h3
              ...
              variants={fadeIn(0.3)}
            >
              Here's how we help you manage risks effectively
            </motion.h3>
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-6xl">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeIn(0.4)}
            >
              Our risk assessment services are designed to help organizations identify, analyze, and mitigate potential threats to their business operations and data security.
            </motion.p>
          </motion.div>
          ...
          >
            {activeTab === 'expertise' && (
              "Our team brings extensive experience in risk assessment and management, ensuring that your organization can identify and address potential threats effectively."
            )}
            {activeTab === 'tailored' && (
              "We recognize that risk profiles vary, and our flexible assessment models allow you to address your organization's specific security concerns."
            )}
            {activeTab === 'proactive' && (
              "We go beyond basic risk assessments. Our team develops comprehensive security strategies that align with your business goals, ensuring proactive threat management."
            )}
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl text-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeIn(0.3)}
            >
              Investing in comprehensive risk assessment isn't a luxury – it's a necessity. It's about protecting your assets, maintaining business continuity, and building trust with your stakeholders. Don't navigate the complex world of security risks alone. Partner with Codezye Cyber to build a robust risk management framework that safeguards your success. Contact us today for a free consultation and discover how our Risk Assessment services can transform your security posture.
            </motion.p>
            <motion.div
              variants={fadeIn(0.5)}
