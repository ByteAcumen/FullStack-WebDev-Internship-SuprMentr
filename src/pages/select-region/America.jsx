...
const America = () => {
  ...
  const [selectedSector, setSelectedSector] = useState('Private Sector');
  ...
  useEffect(() => {
    ...
    try {
      ...
      const region = storedRegion && ['North America', 'South America'].includes(storedRegion) 
        ? storedRegion 
        : 'North America';
      const country = storedCountry && (region === 'North America' 
        ? ['United States', 'Canada', 'Mexico'].includes(storedCountry) 
        : ['Brazil', 'Argentina', 'Chile', 'Colombia', 'Peru'].includes(storedCountry))
        ? storedCountry 
        : region === 'North America' ? 'United States' : 'Brazil';
  ...
  const handleRegionSelect = (region) => {
    setSelectedRegion(region);
    const defaultCountry = region === 'North America' ? 'United States' : 'Brazil';
  ...
  const regions = [
    { name: 'North America', isActive: true },
    { name: 'South America', isActive: true }
  ];

  const sectors = [
    { name: 'Private Sector', isActive: true },
    { name: 'Public & Government', isActive: true }
  ];

  const countries = selectedRegion === 'North America' 
    ? [
        { name: 'United States', isActive: true },
        { name: 'Canada', isActive: true },
        { name: 'Mexico', isActive: true }
      ]
    : [
        { name: 'Brazil', isActive: true },
        { name: 'Argentina', isActive: true },
        { name: 'Chile', isActive: true },
        { name: 'Colombia', isActive: true },
        { name: 'Peru', isActive: true }
      ];
  ...
  return (
    <>
      ...
      <div className="bg-white text-gray-900 min-h-screen overflow-hidden">
        {/* Hero Section */}
        <section className="relative h-[600px] bg-cover bg-center overflow-hidden" style={{ backgroundImage: `linear-gradient(to right, rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.6)), url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80')` }}>
          <motion.div
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12 flex items-center justify-center h-full relative z-10">
            <div className="text-center">
              <motion.h2 
                ...
                aria-level="2"
              >
                Your Trusted Cybersecurity Partner in
              </motion.h2>
              <motion.h1 
        ...
        <section ref={ref1} className="py-24 bg-gray-50 relative">
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              >
                <h2 className="font-semibold text-xl text-blue-900" role="heading" aria-level="2">
              ...
              <motion.p 
                ...
                variants={fadeIn(0.2)}
              >
                Ampcus Cyber offers a comprehensive suite of compliance and privacy solutions designed to address regional challenges across America, ensuring your business is always compliant and protected.
              </motion.p>
              <motion.div 
                className="mt-10"
            ...
            >
              ...
              <div className="relative">
                <motion.button
                  className="py-2 px-6 rounded-full transition-all duration-300 bg-white text-blue-600 border-2 border-blue-200 hover:bg-blue-50 flex items-center"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                ...
                {isCountryDropdownOpen && (
                  <motion.div
                    className="absolute top-full left-0 mt-2 w-full bg-white border border-blue-200 rounded-lg shadow-lg z-10"
                  ...
                  >
                    {countries.map((country) => (
                      <motion.button
                        key={country.name}
                        className="block w-full text-left px-4 py-2 text-blue-600 hover:bg-blue-50 transition-colors duration-200"
            ...
            >
              <svg className="w-full h-auto" viewBox="0 0 1000 200" xmlns="http://www.w3.org/2000/svg" aria-label="America Skyline Illustration">
                <motion.g 
              ...
              >
                <motion.div className="space-y-2">
                  {complianceFrameworks[selectedRegion][selectedSector][selectedCountry].slice(0, Math.ceil(complianceFrameworks[selectedRegion][selectedSector][selectedCountry].length / 2)).map((framework, idx) => (
                    <motion.div
                ...
                <motion.div className="space-y-2">
                  {complianceFrameworks[selectedRegion][selectedSector][selectedCountry].slice(Math.ceil(complianceFrameworks[selectedRegion][selectedSector][selectedCountry].length / 2)).map((framework, idx) => (
                    <motion.div
                      key={`${selectedCountry}-${idx + Math.ceil(complianceFrameworks[selectedRegion][selectedSector][selectedCountry].length / 2)}`}
                      className="flex items-center"
                      initial={{ opacity: 0, x: -10 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.5, delay: 0.2 * (idx + Math.ceil(complianceFrameworks[selectedRegion][selectedSector][selectedCountry].length / 2)) }}
                    >
                      <span className="w-4 h-4 rounded-full bg-blue-500 mr-2 flex items-center justify-center">
                        <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
        ...
        {/* Why Choose Ampcus Cyber Section */}
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              <motion.p 
                ...
                variants={fadeIn(0.2)}
              >
                With extensive experience navigating the complexities of American regulations, Ampcus Cyber is your one-stop shop for all compliance and privacy needs. Our team of regional experts understands the nuances of every legal framework, ensuring a tailored approach that meets your specific requirements.
              </motion.p>
            </motion.div>
            <motion.div 
              ...
              {[
                {
                  ...
                  icon: "🤝",
                  description: "We deeply understand American regulations."
                },
                {
                  title: "Rapid Response",
                  icon: "⏩",
                  description: "Swift, efficient solutions with minimal disruption."
                },
                {
                  title: "Expert Teams",
                  icon: "👥",
                  description: "Proven professionals with American experience."
                },
                {
                  title: "Proven Success",
                  icon: "✅",
                  description: "Track record of effective cybersecurity solutions."
                },
                {
                  title: "Clear Communication",
                  icon: "📢",
                  description: "Transparent updates and collaboration."
                },
                {
                  title: "Regulatory Expertise",
                  icon: "⚖️",
                  description: "Navigating compliance with ease."
                }
              ].map((item, index) => (
                <motion.div 
                  key={item.title}
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              <motion.h2 
                ...
                aria-level="2"
              >
                Ampcus Cyber's Approach – Building a Secure Future in America…
              </motion.h2>
              <motion.p 
                className="text-gray-700 max-w-3xl mx-auto"
                variants={fadeIn(0.2)}
              >
                At Ampcus Cyber, we take a collaborative approach, working closely with your team to understand your unique business needs and compliance challenges.
              </motion.p>
            </motion.div>
            <motion.div 
        ...
        <section className="py-16 bg-gradient-to-b from-white to-blue-100 text-center relative">
          ...
          >
            ...
            <motion.button 
              ...
              aria-label="Get started with Ampcus Cyber"
            >
