...
const SouthEastAsia = () => {
  ...
  const [selectedCountry, setSelectedCountry] = useState('ASEAN');
  ...
  useEffect(() => {
    ...
    try {
      ...
      const country = storedCountry && ['ASEAN', 'Indonesia', 'Malaysia', 'Singapore', 'Myanmar', 'Thailand', 'Vietnam', 'Philippines', 'Cambodia', 'Brunei'].includes(storedCountry) 
        ? storedCountry 
        : 'ASEAN';
      localStorage.setItem('selectedRegion', 'South East Asia');
  ...
  const complianceFrameworks = {
    ASEAN: [
      "ASEAN Framework on Digital Governance",
    ...
    Indonesia: [
      ...
      "Ministry of Communication and Information Technology Regulation 20 of 2016"
    ],
    Malaysia: [
    ...
    Brunei: [
      "Electronic Transactions Act",
      "Computer Misuse Act",
      "Authority for Info-Communications Technology Industry Order",
      "Broadcasting Act"
    ],
  };

  const countries = [
    { name: 'ASEAN', isActive: true },
    { name: 'Indonesia', isActive: true },
    { name: 'Malaysia', isActive: true },
    { name: 'Singapore', isActive: true },
    { name: 'Myanmar', isActive: true },
    { name: 'Thailand', isActive: true },
    { name: 'Vietnam', isActive: true },
    { name: 'Philippines', isActive: true },
    { name: 'Cambodia', isActive: true },
    { name: 'Brunei', isActive: true },
  ];
  ...
  return (
    <>
      ...
      <div className="bg-white text-gray-900 min-h-screen overflow-hidden">
        {/* Hero Section */}
        <section className="relative h-[600px] bg-cover bg-center overflow-hidden" style={{ backgroundImage: `linear-gradient(to right, rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.6)), url('https://images.unsplash.com/photo-1528181304800-259b08848526?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')` }}>
          <motion.div
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              >
                ...
                </span> offers a comprehensive suite of compliance and privacy solutions designed to address regional challenges across South East Asia, ensuring your business is always compliant and protected.
              </motion.p>
              <motion.div 
                className="mt-10"
            ...
            >
              <svg className="w-full h-auto" viewBox="0 0 1000 200" xmlns="http://www.w3.org/2000/svg" aria-label="South East Asia Skyline Illustration">
                <motion.g 
        ...
        {/* Why Choose Codezye Cyber Section */}
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              <motion.p 
                ...
                variants={fadeIn(0.2)}
              >
                With extensive experience navigating the complexities of South East Asian regulations, <span className="font-bold text-blue-500">
                  <span className="bg-gradient-to-r from-blue-500 to-blue-500 bg-clip-text text-transparent">Codezye</span> Cyber
                </span> is your one-stop shop for all compliance and privacy needs. Our team of regional experts understands the nuances of every legal framework, ensuring a tailored approach that meets your specific requirements.
              </motion.p>
            </motion.div>
            <motion.div 
            ...
            >
              {reasons.map((reason, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-blue-900 mb-2" role="heading" aria-level="3">{reason.title}</h3>
          ...
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              >
                <span className="font-bold text-blue-500">
                  <span className="bg-gradient-to-r from-blue-500 to-blue-500 bg-clip-text text-transparent">Codezye</span> Cyber
                </span>'s Approach – Building a Secure Future in South East Asia
              </motion.h2>
              <motion.p 
              ...
              >
                At <span className="font-bold text-blue-500">
                  <span className="bg-gradient-to-r from-blue-500 to-blue-500 bg-clip-text text-transparent">Codezye</span> Cyber
                </span>, we take a collaborative approach, working closely with your team to understand your unique business needs and compliance challenges.
              </motion.p>
            </motion.div>
            <motion.div 
