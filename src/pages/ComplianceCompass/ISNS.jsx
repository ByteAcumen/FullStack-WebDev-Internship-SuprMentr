...
const ISMS_ISO_IEC27001 = () => {
  ...
  const handleGetStarted = () => {
    navigate('/get-started', {
      state: {
        service: 'ISMS ISO/IEC 27001',
        referral: 'isms-landing'
      }
    });
  };
  ...
  const services = [
    {
      title: "ISMS Assessment",
      description: "Comprehensive evaluation of your organization's security controls against ISO/IEC 27001 requirements."
    },
    {
      title: "Implementation Support",
      description: "Expert guidance in implementing necessary controls and changes to meet ISO/IEC 27001 requirements."
    },
    {
      title: "Documentation & Evidence",
      description: "Assistance with creating and maintaining required documentation for ISO/IEC 27001 certification."
    },
    {
    ...
    },
    {
      ...
      description: "End-to-end support throughout the ISO/IEC 27001 certification process, from assessment to final certification."
    }
  ];
      ...
      <nav className="p-4 bg-white shadow-sm">
        <div className="container mx-auto">
          <div className="breadcrumbs text-sm">
            ...
            <span className="mx-2 text-gray-500">»</span>
            <span className="text-gray-800 font-medium">ISMS ISO/IEC 27001</span>
          </div>
        </div>
      </nav>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:gap-16">
            ...
            >
              ...
              <motion.p
                ...
                variants={fadeIn(0.4)}
              >
                Achieve ISO/IEC 27001 certification and build a resilient information security management system. Codezye Cyber helps you implement best practices, secure your data, and meet global standards.
              </motion.p>
              <motion.button
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl text-center">
          ...
          >
            ...
            >
              ...
              <span>FORTIFY YOUR INFORMATION SECURITY</span>
              <span className="w-2 h-2 rounded-full bg-blue-700"></span>
            </motion.div>
            <motion.h2
              className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-6 tracking-tight leading-tight text-blue-600"
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            >
              <h2 className="text-4xl font-bold mb-4 text-blue-600 text-right pr-5">
                WHAT <br />
                WE OFFER <br />
                IN <span className="text-blue-800">ISMS</span> <br />
                CERTIFICATION
              </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-6xl">
          ...
          <div className="flex flex-col gap-6">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeTab === 'expertise' && (
                  "Benefit from the extensive experience and expertise of our team, committed to staying abreast of evolving compliance standards."
                )}
                {activeTab === 'tailored' && (
                  "We develop customized solutions that address your specific business needs and compliance requirements."
                )}
                {activeTab === 'proactive' && (
                  "Our approach goes beyond compliance to implement proactive security measures that protect your business from emerging threats."
                )}
              </motion.div>
            </AnimatePresence>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl text-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeIn(0.3)}
            >
              Investing in ISO/IEC 27001 certification isn't just about meeting requirements – it's about protecting your data, building trust, and enabling quality service delivery. Don't leave your compliance to chance. Partner with Codezye Cyber to develop a robust security framework that safeguards your success. Contact us today for a free consultation and discover how our ISO/IEC 27001 certification services can transform your security posture.
            </motion.p>
            <motion.div
              variants={fadeIn(0.5)}
...
export default ISMS_ISO_IEC27001;