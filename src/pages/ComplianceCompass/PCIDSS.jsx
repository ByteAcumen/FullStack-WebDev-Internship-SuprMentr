...
const PCIDSS = () => {
  ...
  const benefits = [
    {
      title: "Expert PCI QSA Team",
      description: "Our certified PCI QSA professionals bring extensive experience in conducting thorough security assessments and guiding organizations through the compliance process."
    },
    {
      title: "Comprehensive Implementation Support",
      description: "We provide end-to-end support in implementing necessary controls and changes to meet PCI DSS requirements effectively."
    },
    {
      title: "Documentation Excellence",
      description: "Our team helps you create and maintain the required documentation for PCI DSS compliance and audits, ensuring nothing is overlooked."
    },
    {
      title: "Proactive Security Measures",
      description: "We go beyond compliance to help you build a robust security framework that protects cardholder data and prevents security breaches."
    }
  ];
  ...
  const services = [
    {
      ...
      description: "Undergo thorough security assessments conducted by our PCI QSA professionals, ensuring a rigorous evaluation of your compliance posture."
    },
    {
      title: "Implementation Support",
      description: "Get expert guidance on implementing necessary controls and changes to meet PCI DSS requirements effectively."
    },
    {
      title: "Documentation Assistance",
      description: "Receive help with creating and maintaining the required documentation for PCI DSS compliance and audits."
    },
    {
      title: "Vulnerability Management",
      description: "Access our robust vulnerability scanning and management services to identify and address security weaknesses."
    },
    {
      title: "Training Programs",
      description: "Participate in comprehensive training programs for your staff to understand and maintain PCI DSS compliance."
    }
  ];
      ...
      <nav className="p-4 bg-white shadow-sm">
        <div className="container mx-auto">
          <div className="breadcrumbs text-sm">
            ...
            <span className="mx-2 text-gray-500">»</span>
            <span className="text-gray-800 font-medium">PCI DSS</span>
          </div>
        </div>
      </nav>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:gap-16">
            ...
            >
              ...
              <motion.p
                ...
                variants={fadeIn(0.3)}
              >
                Simplify the Journey, Strengthen Your Data Security Posture!
              </motion.p>
              <motion.p
                className="text-gray-600 max-w-lg leading-relaxed text-lg mb-8"
                variants={fadeIn(0.4)}
              >
                Meeting the rigorous requirements of PCI DSS can be challenging. Codezye Cyber streamlines your path to compliance with our expert-led PCI DSS Certification services.
              </motion.p>
              <motion.button
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl text-center">
          ...
          >
            ...
            >
              ...
              <span>SECURE YOUR PAYMENT CARD DATA</span>
              <span className="w-2 h-2 rounded-full bg-blue-700"></span>
            </motion.div>
            <motion.h2
              className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-6 tracking-tight leading-tight text-blue-600"
              variants={fadeIn(0.3)}
            >
              Secure Your Payment Card Data with PCI DSS Compliance
            </motion.h2>
            <motion.p
              className="text-xl text-gray-700 mb-6 leading-relaxed"
              variants={fadeIn(0.4)}
            >
              In today's digital payment landscape, PCI DSS compliance isn't just a requirement – it's a critical component of your security strategy.
            </motion.p>
            <motion.p
              className="text-gray-600 text-lg leading-relaxed"
              variants={fadeIn(0.5)}
            >
              We're not just compliance consultants. We're security partners who understand that PCI DSS compliance must be practical, sustainable, and aligned with your business objectives.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            >
              <h2 className="text-4xl font-bold mb-4 text-blue-600 text-right pr-5">
                WHAT <br />
                WE OFFER <br />
                IN <span className="text-blue-800">PCI DSS</span> <br />
                COMPLIANCE
              </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-6xl">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeIn(0.4)}
            >
              Our PCI DSS compliance services are designed to help organizations achieve and maintain compliance while building a robust security framework.
            </motion.p>
          </motion.div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeTab === 'expertise' && (
                  "Our team brings extensive experience in PCI DSS compliance and security assessments, ensuring that your organization can achieve and maintain compliance effectively."
                )}
                {activeTab === 'tailored' && (
                  "We recognize that each organization has unique security needs, and our flexible approach allows us to develop compliance solutions that address your specific requirements."
                )}
                {activeTab === 'proactive' && (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl text-center">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeIn(0.3)}
            >
              Investing in PCI DSS compliance isn't just about meeting requirements – it's about protecting your business, building trust with customers, and enabling secure payment processing.
            </motion.p>
            <motion.p
              className="text-gray-600 text-lg mb-12 leading-relaxed"
              variants={fadeIn(0.4)}
            >
              Don't leave your compliance to chance. Partner with Codezye Cyber to develop a robust security framework that safeguards your success.
            </motion.p>
